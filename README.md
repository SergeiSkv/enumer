...
This was again forked here as (https://github.com/SergeiSkv/enumer) picking up where Álvaro left off.
...
For more information, see:
        http://godoc.org/github.com/SergeiSkv/enumer
Flags:
  -addprefix string
...
```golang
//go:generate go run github.com/SergeiSkv/enumer -type=YOURTYPE
```
